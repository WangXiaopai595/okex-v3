...
class AccountAPI(Client):
    ...
    def __init__(self, api_key, api_secret_key, passphrase, use_server_time=False, flag='0', proxy=None):
        Client.__init__(self, api_key, api_secret_key, passphrase, use_server_time, flag, proxy)
